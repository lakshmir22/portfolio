  ...
  return (
    <section id="home" className="relative flex min-h-screen items-center justify-center overflow-hidden pt-16">
      ...
      <div className="container relative z-10 px-4 text-center">
        ...
        >
          <a href="https://www.dropbox.com/scl/fi/3qreyjoej9ha3shrnjc6t/Resume.pdf?rlkey=9ewsrnfg5qpq8zou1kpqsroje&st=al540nuf&dl=0" className="btn btn-primary px-8 py-3 text-base">
          Resume
          </a>
