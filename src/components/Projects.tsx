  ...
  const projects: Project[] = [
    {
      ...
      github: 'https://github.com/lakshmir22/ecommerce-platform',
      demo: 'https://ecommerce-demo.lakshmirai.com',
    },
    {
      title: 'Task Management App',
      description:
        'A productivity application for managing tasks, projects, and deadlines with real-time updates and team collaboration features.',
      technologies: ['Next.js', 'TypeScript', 'Firebase', 'Tailwind CSS'],
      image: '/placeholder.jpg',
      github: 'https://github.com/lakshmir22/task-manager',
      demo: 'https://tasks.lakshmirai.com',
    },
    {
      title: 'Weather Dashboard',
      description:
        'A weather application that provides current conditions and forecasts for locations worldwide using weather API integration.',
      technologies: ['React', 'Redux', 'OpenWeather API', 'Chart.js'],
      image: '/placeholder.jpg',
      github: 'https://github.com/lakshmir22/weather-dashboard',
      demo: 'https://weather.lakshmirai.com',
    },
    {
      title: 'Social Media Analytics',
      description:
        'A data visualization tool for analyzing social media metrics and engagement across multiple platforms.',
      technologies: ['Vue.js', 'D3.js', 'Node.js', 'Express', 'PostgreSQL'],
      image: '/placeholder.jpg',
      github: 'https://github.com/lakshmir22/social-analytics',
    },
  ];
