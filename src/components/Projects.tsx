...
export const Projects = () => {
  ...
  const projects: Project[] = [
    ...
    {
      title: 'English Vocabulary Quiz Application',
      description:
        'An adaptive vocabulary learning platform, featuring multi-level quizzes, visual aids, and pronunciation audio for effective retention.',
      technologies: ['HTML', 'CSS', 'JavaScript', 'Express.js', 'SQL'],
      image: '/placeholder.jpg',
